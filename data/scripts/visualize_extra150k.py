"""
Generate 150,000 additional images from train_jsonl, skipping any record
already used in viz_50000 or viz_100000 (matched by source_file + source_line).

Usage:
    python data/scripts/visualize_extra150k.py
"""
...
EXISTING_MAPS = [
    DATA_DIR / "viz_50000"  / "mapping.jsonl",
    DATA_DIR / "viz_100000" / "mapping.jsonl",
]
OUT_DIR = DATA_DIR / "viz_150000"
