...
def build_parser(defaults=None):
    ...
    parser.add_argument("--num_layers",   type=int,   default=defaults.get("num_layers",   12))
    parser.add_argument("--num_heads",    type=int,   default=defaults.get("num_heads",    12))
    parser.add_argument("--timesteps",    type=int,   default=defaults.get("timesteps",    1000))
    parser.add_argument("--bert",         default=defaults.get("bert", "models/bge-small-en-v1.5"))
