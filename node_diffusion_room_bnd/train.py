"""
Train NodeDiffusionTransformer（四流：adj_attn + room_attn + global_attn + bnd_attn）。

需要先用 node_diffusion_room_bnd/build_graph_npz.py 生成含 is_boundary 的新 npz。
...
def build_parser(defaults=None):
    ...
    parser.add_argument("--data_path",    default=defaults.get("data_path", "data/processed/node_diffusion_room_bnd/graph_dataset.npz"))
    parser.add_argument("--save_dir",     default=defaults.get("save_dir",  "checkpoints/node_diffusion_room_bnd"))
