...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-file", type=Path, default=Path("data/jsonl/viz_100000_captions_multi_en.jsonl"))
    parser.add_argument("--state-file", type=Path, default=Path("data/jsonl/viz_100000_captions_multi_en.state.json"))
