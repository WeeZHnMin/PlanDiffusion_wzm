...
% ─────────────────────────────────────────────────────────────────────────────
%  ENCODER  ×6
%  Sub-layers: (1) Adj Self-Attn  (2) Cross-Attn  (3) FFN
% ─────────────────────────────────────────────────────────────────────────────
\node[W={Cs}]  (ln1)  at (0, -5.2)  {LayerNorm};
\node[W={Cs}, below=0.55cm of ln1]  (aa)
  {Adjacency Self-Attention};
\node[C={Cs}, below=0.4cm of aa]    (add1) {$+$};
...
\begin{scope}[on background layer]
  \node[grp, fit=(ln1)(aa)(add1)(ln2)(ca)(add2)(ln3)(ffn)(add3),
        inner sep=11pt] (Genc) {};
\end{scope}
...
% ln1 → adj self-attn → add1
\draw[a] (ln1.south) -- (aa.north);
\draw[a] (aa.south)  -- (add1.north);

% residual skip 1: ni bypasses ln1+aa to add1
\draw[sk]
