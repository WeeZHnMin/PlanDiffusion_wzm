"""
Train NodeDiffusionTransformer（三流 + AdaLN 文本条件）。

使用方法（单卡）：
  python -m node_diffusion_room_adaln.train \\
      --data_path data/processed/node_diffusion_room_tri/graph_dataset.npz \\
      --save_dir  checkpoints/node_diffusion_room_adaln
"""
...
def build_parser(defaults=None):
    ...
    parser.add_argument("--save_dir",     default=defaults.get("save_dir",  "checkpoints/node_diffusion_room_adaln"))
