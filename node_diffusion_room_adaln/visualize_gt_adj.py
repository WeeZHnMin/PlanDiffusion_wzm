...
def parse_args():
    ...
    p.add_argument('--ckpt',    default='checkpoints/node_diffusion_room_adaln/latest.pt')
    ...
    p.add_argument('--vocab',     default="node_diffusion_room_adaln/type_combo_vocab_v3.json")
    return p.parse_args()
